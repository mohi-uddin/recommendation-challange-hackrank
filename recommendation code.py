...
challenges = pd.read_csv('D:\gulpie\hackerrank-challenge-recommendation-dataset\challenges.csv')

submissions = pd.read_csv('D:\gulpie\hackerrank-challenge-recommendation-dataset\submissions.csv')
